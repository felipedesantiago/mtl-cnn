...
EPOCHS = 3 #40
STEPS_EPOCHS = 100 #  1182  # training images #trainimages / batch_size * 2 (2 because of DA flip)
STEPS_VAL = 30 #294  # valid images #trainimages / batch_size * 2 (2 because of DA flip)
